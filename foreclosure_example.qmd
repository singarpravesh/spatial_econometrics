...
## Spatial autocorreltaion and spatial heterogeniety
...
Autocorrelation:
        Measures the similarity between nearby observations.
        Focuses on the correlation between neighboring values.
        Can be caused by various factors, including diffusion processes, attributional processes, and behavioral heterogeneity.
    Heterogeneity:
        Measures the variation in the mean or intensity of a spatial process across different locations.
        Focuses on the differences in the characteristics of the spatial process across locations.
        Can be caused by various factors, including differences in environmental conditions, population density, or other local factors.
